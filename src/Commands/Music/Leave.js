...
module.exports = class extends Command {
    ...
    async run(message, ...args) {
        ...
        this.client.distube.voices.leave(member.voice.channel).catch(err => { return message.channel.send('An error occured.') }).catch(err => { return message.channel.send('An error occured.') })
